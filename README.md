...
data science: python, scikit-learn, xgboost, sql, r (throwback), pandas
data engineering: snowflake, aws, fivetran, airflow, kafka, spark
bi tools: tableau, powerbi, apache superset
currently exploring: llms, nlp, generative ai for analytics

## what i like
you'll find me wrenching under a bmw hood or breaking door panels trying to change window regulators.
## socials
connect with me on linkedin or drop me an email at andrekef@gmail.com.
